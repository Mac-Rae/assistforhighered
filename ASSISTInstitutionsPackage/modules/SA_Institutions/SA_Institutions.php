...
class SA_Institutions extends Company
{
    public $new_schema = true;
    public $module_dir = 'SA_Institutions';
    public $object_name = 'SA_Institutions';
    public $table_name = 'sa_institutions';
