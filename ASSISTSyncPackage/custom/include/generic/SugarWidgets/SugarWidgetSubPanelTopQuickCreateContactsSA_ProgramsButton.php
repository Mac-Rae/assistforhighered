...
class SugarWidgetSubPanelTopQuickCreateContactsSA_ProgramsButton extends SugarWidgetSubPanelTopButtonQuickCreate
{
    ...
    function display($defines)
    {
        ...
        $additionalFormFields = array();        if (! empty($defines['focus']->name)) {
            $additionalFormFields['contacts_name'] = $defines['focus']->name;
        }        if (! empty($defines['focus']->id)) {
            $additionalFormFields['contacts_id'] = $defines['focus']->id;
        }
