...
<table border='0' cellpadding='0' cellspacing='0' width='100%'>
    <tr>
        <td width='99%'>
            {if !$fields.{{$displayParams.key}}_address_street.assist_field_hidden}
            ...
            {/if}
            {if !$fields.{{$displayParams.key}}_address_city.assist_field_hidden}
            ...
            {/if}
            {if !$fields.{{$displayParams.key}}_address_state.assist_field_hidden}
            ...
            {/if}
            {if !$fields.{{$displayParams.key}}_address_country.assist_field_hidden}
            ...
            {/if}
            {if !$fields.{{$displayParams.key}}_address_postalcode.assist_field_hidden}
            ...
            {if $fields.{{$displayParams.key}}_address_city.assist_field_hidden}
                {include file='custom/include/SugarFields/Redacted.tpl' vardef={{$vardef.name}}}
            {else}
            {$fields.{{$displayParams.key}}_address_city.value|escape:'html_entity_decode'|escape:'html'|url2html|nl2br}{/if}{if !$fields.{{$displayParams.key}}_address_state.assist_field_hidden} {$fields.{{$displayParams.key}}_address_state.value|escape:'html_entity_decode'|strip_tags|url2html|nl2br}{/if}
            &nbsp;&nbsp;{if $fields.{{$displayParams.key}}_address_postalcode.assist_field_hidden}    {include file='custom/include/SugarFields/Redacted.tpl' vardef={{$vardef.name}}}
            {else}{$fields.{{$displayParams.key}}_address_postalcode.value|escape:'html_entity_decode'|strip_tags|url2html|nl2br}{/if}
            <br>
            {if $fields.{{$displayParams.key}}_address_country.assist_field_hidden}
                {include file='custom/include/SugarFields/Redacted.tpl' vardef={{$vardef.name}}}
            {else}
