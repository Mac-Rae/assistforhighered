<?php
require_once 'modules/Campaigns/DotListWizardMenu.php';
class BulkCasesDotListWizardMenu extends DotListWizardMenu{
    private $html;
    ...
    {
        $html = file_get_contents('custom/modules/Campaigns/tpls/progressStepsStyle.html');
        $html .=
