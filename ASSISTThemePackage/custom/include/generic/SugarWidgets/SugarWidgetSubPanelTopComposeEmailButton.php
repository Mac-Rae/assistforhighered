...
class SugarWidgetSubPanelTopComposeEmailButton extends SugarWidgetSubPanelTopButton
{
    ...
    public function &_get_form($defines, $additionalFormFields = null, $nonbutton = false)
    {
        ...
        /** @var Person|Company|Opportunity $b'
            . ean */
        $bean = $defines['focus'];
    ...
    public function display($defines, $additionalFormFields = null, $nonbutton = false)
    {
        ...
        $client = $current_user->getEmailClient();
        $bean = $defines['focus'];
        $button .= '<script src="https://cdnjs.cloudflare.com/ajax/libs/tinymce/5.7.0/tinymce.min.js" integrity="sha512-XaygRY58e7fVVWydN6jQsLpLMyf7qb4cKZjIi93WbKjT6+kG/x4H5Q73Tff69trL9K0YDPIswzWe6hkcyuOHlw==" crossorigin="anonymous"></script>';
        if ($client == 'sugar') {
            $button .= "<input class='button' onclick='$(document).openComposeViewModal(this);' type='button' id='$inputID' value='$this->form_value'"
