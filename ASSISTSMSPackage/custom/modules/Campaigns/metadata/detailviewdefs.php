    ...
    array(
      ...
      array(
        ...
        array(
          ...
          7 => array(
            'customCode' => '{if $fields.campaign_type.value == "SA_SMS"}<input title="{$MOD.LBL_SA_SMS_EXECUTE_NOW}" class="button" onclick="if(!confirm(\'{$MOD.LBL_SA_SMS_EXECUTE_CONFIRM}\')){ldelim}return false;{rdelim};scheduleSMS();" type="button" name="sa_sms_button" id="sa_sms_button" value="{$MOD.LBL_SA_SMS_EXECUTE_NOW}">{/if}',
          ),
          8 =>
          array(
