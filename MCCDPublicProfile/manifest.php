...
$manifest = [
    ...
    'key' => 'SA',
    'author' => 'SalesAgility',
    'description' => 'MCCD Public User Profiles',
    'icon' => '',
    'is_uninstallable' => '1',
    'name' => 'MCCD Public User Profiles',
...
$installdefs = [
    'copy' => [
        ...
        '6' => [
            'from' => '<basepath>/custom/Extension/modules/Contacts/Ext/Language/en_us.MCCDNormalisedPhone.php',
            'to' => 'custom/Extension/modules/Contacts/Ext/Language/en_us.MCCDNormalisedPhone.php',
            ],
        '7' => [
            'from' => '<basepath>/custom/Extension/modules/Contacts/Ext/LogicHooks/MCCDNormalisedPhone.php',
            'to' => 'custom/Extension/modules/Contacts/Ext/LogicHooks/MCCDNormalisedPhone.php',
            ],
        '8' => [
            'from' => '<basepath>/custom/Extension/modules/Contacts/Ext/Vardefs/MCCDNormalisedPhone.php',
            'to' => 'custom/Extension/modules/Contacts/Ext/Vardefs/MCCDNormalisedPhone.php',
            ],
        '9' => [
            'from' => '<basepath>/custom/Extension/modules/Leads/Ext/Language/en_us.MCCDNormalisedPhone.php',
            'to' => 'custom/Extension/modules/Leads/Ext/Language/en_us.MCCDNormalisedPhone.php',
            ],
        '10' => [
            'from' => '<basepath>/custom/Extension/modules/Leads/Ext/LogicHooks/MCCDNormalisedPhone.php',
            'to' => 'custom/Extension/modules/Leads/Ext/LogicHooks/MCCDNormalisedPhone.php',
            ],
        '11' => [
            'from' => '<basepath>/custom/Extension/modules/Leads/Ext/Vardefs/MCCDNormalisedPhone.php',
            'to' => 'custom/Extension/modules/Leads/Ext/Vardefs/MCCDNormalisedPhone.php',
            ],
        '12' => [
            'from' => '<basepath>/custom/Extension/modules/Meetings/Ext/Language/en_us.MCCDPublicProfile.php',
            'to' => 'custom/Extension/modules/Meetings/Ext/Language/en_us.MCCDPublicProfile.php',
            ],
        '13' => [
            'from' => '<basepath>/custom/Extension/modules/Meetings/Ext/Vardefs/MCCDPublicProfile.php',
            'to' => 'custom/Extension/modules/Meetings/Ext/Vardefs/MCCDPublicProfile.php',
            ],
        '14' => [
