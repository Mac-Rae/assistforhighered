...
<head>
    ...
    {php}
        global $sugar_config;
        $this->assign('gtag_token',$sugar_config['googleanalytics']['token']);
    {/php}
    {if $gtag_token}
    {literal}
    <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id={/literal}{$gtag_token}{literal}"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());
        gtag('config', {/literal}{$gtag_token|json_encode}{literal});
    </script>
    {/literal}
    {/if}
</head>
